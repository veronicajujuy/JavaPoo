...
public class UIMenu {
    ...
    private static void authUser(int userType){
        ...
        doctors.add(new Doctor("Alejandro Martinez", "alejandro@mail.com","Dentista"));
        doctors.add(new Doctor("Karen Sosa", "kare@mail.com", "Ginecologia"));
        doctors.add(new Doctor("Rocío Gómez", "rocio@mail.com", "Dermatología"));
